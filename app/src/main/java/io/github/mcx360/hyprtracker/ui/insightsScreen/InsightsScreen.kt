...
import io.github.mcx360.hyprtracker.ui.insightsScreen.components.Filter
...
fun GraphScreen(
    ...
    if (uiState.hasRecords) {
        Column(
            ...
            Filter(setFilterDates = { startDate, endDate -> insightsViewModel.setTimePeriod(startDate, endDate) })
